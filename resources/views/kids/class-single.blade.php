...
<!-- Mirrored from labartisan.net/demo/kidsacademy/class-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 21 Feb 2023 12:38:42 GMT -->
<head>
  <meta charset="utf-8">
            ...
            <div class="menu-area">
              ...
              <ul class="menu">
                ...
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    <li><a href="{{url('/classes')}}">Classes</a></li>
                    <li class="active"><a href="{{url('/class-single')}}">Classes Details</a></li>
                  </ul>
                </li>
                <li class="dropdown">
                  <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
        ...
        <div class="col-lg-8">
          <div class="single-post">
            <div class="post-image">
              <img src="{{asset('images/classes/class-single.jpg')}}" alt="post image" class="img-responsive">
            </div>
...
<!-- Mirrored from labartisan.net/demo/kidsacademy/class-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 21 Feb 2023 12:38:46 GMT -->
</html>
