...
<!-- Mirrored from labartisan.net/demo/kidsacademy/gallery-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 21 Feb 2023 12:38:46 GMT -->
<head>
  <meta charset="utf-8">
            ...
            <div class="menu-area">
              ...
              <ul class="menu">
                ...
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    <li><a href="{{url('/gallery')}}">Gallery</a></li>
                    <li class="active"><a href="{{url('/gallery-2')}}">Gallery Two</a></li>
                    <li><a href="{{url('/event')}}">Event</a></li>
