...
<!-- Mirrored from labartisan.net/demo/kidsacademy/shop-cart.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 21 Feb 2023 12:39:03 GMT -->
<head>
  <meta charset="utf-8">
              ...
              <ul class="menu">
                ...
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li><a href="{{url('/product-details')}}">Product Details</a></li>
                    <li class="active"><a href="{{url('/shop-cart')}}">Shop Cart</a></li>
                  </ul>
                </li>
          ...
          <tbody>
            <tr>
              <td colspan="2" class="product-thumbnail">
                <div class="image">
                  <a href="{{url('/shop-page')}}"><img src="{{asset('images/product/cart_01.jpg')}}" alt="product image"
                      class="img-responsive"></a>
                </div>
                <div class="content">
                  <h4><a href="{{url('/shop-page')}}">Product Title Here</a></h4>
                </div>
              </td>
            ...
            <tr>
              <td colspan="2" class="product-thumbnail">
                <div class="image">
                  <a href="{{url('/shop-page')}}"><img src="{{asset('images/product/cart_02.jpg')}}" alt="product image"
                      class="img-responsive"></a>
                </div>
                <div class="content">
                  <h4><a href="{{url('/shop-page')}}">Product Title Here</a></h4>
              ...
              <td><span>$440.00</span></td>
              <td class="quantity">

                <input type="text" value="1" />

              </td>
              <td class="total-cart"><span>$880.00</span></td>
              <td class="remove-cart">
                <span><i class="fa fa-times" aria-hidden="true"></i></span>
              </td>
            </tr>
            <tr>
              <td colspan="2" class="product-thumbnail">
                <div class="image">
                  <a href="{{url('/shop-page')}}"><img src="{{asset('images/product/cart_03.jpg')}}" alt="product image"
                      class="img-responsive"></a>
                </div>
                <div class="content">
                  <h4><a href="{{url('/shop-page')}}">Product Title Here</a></h4>
              ...
              <td class="total-cart"><span>$440.00</span></td>
              <td class="remove-cart">
                <span><i class="fa fa-times" aria-hidden="true"></i></span>
              </td>
            </tr>
            <tr>
              <td colspan="2" class="product-thumbnail">
                <div class="image">
                  <a href="{{url('/shop-page')}}"><img src="{{asset('images/product/cart_04.jpg')}}" alt="product image"
                      class="img-responsive"></a>
                </div>
                <div class="content">
                  <h4><a href="{{url('/shop-page')}}">Product Title Here</a></h4>
              ...
              <td class="total-cart"><span>$600.00</span></td>
              <td class="remove-cart">
                <span><i class="fa fa-times" aria-hidden="true"></i></span>
              </td>
            </tr>
            <tr>
              <td colspan="2" class="product-thumbnail">
                <div class="image">
                  <a href="{{url('/shop-page')}}"><img src="{{asset('images/product/cart_05.jpg')}}" alt="product image"
                      class="img-responsive"></a>
                </div>
                <div class="content">
                  <h4><a href="{{url('/shop-page')}}">Product Title Here</a></h4>
              ...
              <td class="total-cart"><span>$720.00</span></td>
              <td class="remove-cart">
                <span><i class="fa fa-times" aria-hidden="true"></i></span>
              </td>
            </tr>
...
<!-- Mirrored from labartisan.net/demo/kidsacademy/shop-cart.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 21 Feb 2023 12:39:05 GMT -->
</html>
