...
<!-- Mirrored from labartisan.net/demo/kidsacademy/event.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 21 Feb 2023 12:38:46 GMT -->
<head>
  <meta charset="utf-8">
      ...
      <div class="event-items">
        <div class="row">
          ...
          <div class="col-lg-4 col-sm-6 col-xs-12">
            <div class="event-item">
              <div class="event-image">
                <img src="{{asset('images/event/event_04.jpg')}}" alt="event image" class="img-responsive">
                <div class="date">
                  <span>24</span>
                  <p>March</p>
                </div>
          ...
          <div class="col-lg-4 col-sm-6 col-xs-12">
            <div class="event-item">
              <div class="event-image">
                <img src="{{asset('images/event/event_05.jpg')}}" alt="event image" class="img-responsive">
                <div class="date">
                  <span>24</span>
                  <p>March</p>
                </div>
          ...
          <div class="col-lg-4 col-sm-6 col-xs-12">
            <div class="event-item">
              <div class="event-image">
                <img src="{{asset('images/event/event_06.jpg')}}" alt="event image" class="img-responsive">
                <div class="date">
                  <span>24</span>
                  <p>March</p>
                </div>
          ...
          <div class="col-lg-4 col-sm-6 col-xs-12">
            <div class="event-item">
              <div class="event-image">
                <img src="{{asset('images/event/event_07.jpg')}}" alt="event image" class="img-responsive">
                <div class="date">
                  <span>24</span>
                  <p>March</p>
                </div>
          ...
          <div class="col-lg-4 col-sm-6 col-xs-12">
            <div class="event-item">
              <div class="event-image">
                <img src="{{asset('images/event/event_08.jpg')}}" alt="event image" class="img-responsive">
                <div class="date">
                  <span>24</span>
                  <p>March</p>
                </div>
          ...
          <div class="col-lg-4 col-sm-6 col-xs-12">
            <div class="event-item">
              <div class="event-image">
                <img src="{{asset('images/event/event_09.jpg')}}" alt="event image" class="img-responsive">
                <div class="date">
                  <span>24</span>
                  <p>March</p>
                </div>
...
<!-- Mirrored from labartisan.net/demo/kidsacademy/event.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 21 Feb 2023 12:38:48 GMT -->
</html>
