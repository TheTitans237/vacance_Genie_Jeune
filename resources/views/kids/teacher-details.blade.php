...
<!-- Mirrored from labartisan.net/demo/kidsacademy/teacher-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 21 Feb 2023 12:39:05 GMT -->
<head>
  <meta charset="utf-8">
              ...
              <ul class="menu">
                ...
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li class="active"><a href="{{url('/teacher-details')}}">Teacher Details</a></li>
                  </ul>
                </li>
                <li class="dropdown">
                  <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
      ...
      <div class="row">
        <div class="col-lg-6 col-xs-12">
          <div class="teacher-image">
            <img src="{{asset('images/teachers/teacher-details.jpg')}}" alt="teacher image" class="img-responsive">
          </div>
        </div>
        <div class="col-lg-6 col-xs-12">
      ...
      <div class="row">
        ...
        <div class="col-lg-6 col-xs-12">
          <div class="teacher-award">
            ...
            <ul>
              <li>
                <img src="{{asset('images/teachers/award_01.png')}}" alt="award image" class="img-responsive">
                <span>Aword 2021</span>
              </li>
              <li>
                <img src="{{asset('images/teachers/award_02.png')}}" alt="award image" class="img-responsive">
                <span>Aword 2015</span>
              </li>
              <li>
                <img src="{{asset('images/teachers/award_03.png')}}" alt="award image" class="img-responsive">
                <span>Aword 2014</span>
              </li>
              <li>
                <img src="{{asset('images/teachers/award_04.png')}}" alt="award image" class="img-responsive">
...
<!-- Mirrored from labartisan.net/demo/kidsacademy/teacher-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 21 Feb 2023 12:39:07 GMT -->
</html>
