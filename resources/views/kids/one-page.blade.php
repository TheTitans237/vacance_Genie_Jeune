            ...
            <div class="gallery-items">
                <div class="gallery-item branding packing">
                    <div class="gallery-image">
                        <img src="{{ asset('images/gallery/gallery_01.jpg') }}" alt="gallery image"
                            class="img-responsive">
                ...
                <div class="gallery-item development photography">
                    <div class="gallery-image">
                        <img src="{{ asset('images/gallery/gallery_02.jpg') }}" alt="gallery image"
                            class="img-responsive">
                        <div class="gallery-overlay">
                            <div class="bg"></div>
                        </div>
                ...
                <div class="gallery-item branding packing">
                    <div class="gallery-image">
                        <img src="{{ asset('images/gallery/gallery_03.jpg') }}" alt="gallery image"
                            class="img-responsive">
                        <div class="gallery-overlay">
                            <div class="bg"></div>
                        </div>
                        <div class="gallery-content">
                            <a href="{{ asset('images/gallery/gallery_bg_03.jpg') }}"
                                data-rel="lightcase:myCollection"><i class="icon flaticon-expand"></i></a>
                            <h4>Product Name Here</h4>
                            <span>By: KidsAcademy Theme</span>
                        </div>
                ...
                <div class="gallery-item development photography">
                    <div class="gallery-image">
                        <img src="{{ asset('images/gallery/gallery_04.jpg') }}" alt="gallery image"
                            class="img-responsive">
                        <div class="gallery-overlay">
                            <div class="bg"></div>
                        </div>
                        <div class="gallery-content">
                            <a href="{{ asset('images/gallery/gallery_bg_04.jpg') }}"
                                data-rel="lightcase:myCollection"><i class="icon flaticon-expand"></i></a>
                            <h4>Product Name Here</h4>
                            <span>By: KidsAcademy Theme</span>
                        </div>
                ...
                <div class="gallery-item branding packing">
                    <div class="gallery-image">
                        <img src="{{ asset('images/gallery/gallery_05.jpg') }}" alt="gallery image"
                            class="img-responsive">
                        <div class="gallery-overlay">
                            <div class="bg"></div>
                        </div>
                    ...
                    <div class="partner-slider swiper-container">
                        <div class="swiper-wrapper">
                            <div class="partner-item swiper-slide">
                                <img src="{{ asset('images/partner/partner_01.jpg') }}" alt="partner image"
                                    class="img-responsive">
                            </div><!-- partner-item -->
                            <div class="partner-item swiper-slide">
                                <img src="{{ asset('images/partner/partner_02.jpg') }}" alt="partner image"
                                    class="img-responsive">
                            </div><!-- partner-item -->
                            <div class="partner-item swiper-slide">
                                <img src="{{ asset('images/partner/partner_03.jpg') }}" alt="partner image"
                                    class="img-responsive">
                            </div><!-- partner-item -->
                            <div class="partner-item swiper-slide">
                                <img src="{{ asset('images/partner/partner_04.jpg') }}" alt="partner image"
                                    class="img-responsive">
                            </div><!-- partner-item -->
                            <div class="partner-item swiper-slide">
                                <img src="{{ asset('images/partner/partner_05.jpg') }}" alt="partner image"
                                    class="img-responsive">
                            </div><!-- partner-item -->
                            <div class="partner-item swiper-slide">
                                <img src="{{ asset('images/partner/partner_01.jpg') }}" alt="partner image"
            ...
            <div class="blog-items">
                <div class="row">
                    <div class="col-lg-4 col-sm-6 col-xs-12">
                        <div class="blog-item">
                            <div class="blog-image">
                                <a href="{{ url('/single') }}"><img src="{{ asset('images/blog/blog_01.jpg') }}"
                    ...
                    <div class="col-lg-4 col-sm-6 col-xs-12">
                        <div class="blog-item">
                            <div class="blog-image">
                                <a href="{{ url('/single') }}"><img src="{{ asset('images/blog/blog_02.jpg') }}"
                                        alt="blog image" class="img-responsive"></a>
                            </div>
                            <div class="blog-content">
                                <h4><a href="{{ url('/single') }}">Actanualze Cententrc Staled</a></h4>
                    ...
                    <div class="col-lg-4 col-sm-6 col-xs-12">
                        <div class="blog-item">
                            <div class="blog-image">
                                <a href="{{ url('/single') }}"><img src="{{ asset('images/blog/blog_03.jpg') }}"
                                        alt="blog image" class="img-responsive"></a>
                            </div>
                            <div class="blog-content">
                                <h4><a href="{{ url('/single') }}">Actanualze Cententrc Staled</a></h4>
