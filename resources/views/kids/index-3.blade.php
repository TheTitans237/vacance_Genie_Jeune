...
<!-- Mirrored from labartisan.net/demo/kidsacademy/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 21 Feb 2023 12:38:28 GMT -->
<head>
  <meta charset="utf-8">
          ...
          <div class="col-md-9">
            <ul class="top-contents">
              ...
              <li>
                ...
                <div class="content">
                  <p>Our Address</p>
                  <span>Lagartisan 1205 Newyork</span>
                </div>
              </li>
            </ul>
          </div>
              ...
              <ul class="menu">
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li class="active"><a href="{{url('/index-3')}}">Home Style 02</a></li>
        ...
        <div class="banner-item slide-one swiper-slide">
          ...
          <div class="container">
            <div class="banner-content">
              ...
              <h2>Best For Education Theme</h2>
      ...
      <div class="row">
        <div class="col-lg-6">
          <div class="about-image">
            <img src="{{asset('images/about/about-2.png')}}" alt="about image" class="img-responsive">
          </div>
        </div>
        <div class="col-lg-6">
            ...
            <div class="swiper-wrapper">
              <div class="teacher-item swiper-slide">
                ...
                <div class="teacher-content">
                  <h4><a href="{{url('/teacher-details')}}">Broklyn Doel</a></h4>
              ...
              <div class="teacher-item swiper-slide">
                ...
                <div class="teacher-content">
                  <h4><a href="{{url('/teacher-details')}}">Alex barbe</a></h4>
              ...
              <div class="teacher-item swiper-slide">
                ...
                <div class="teacher-content">
                  <h4><a href="{{url('/teacher-details')}}">Healex hen</a></h4>
                  <span>Sains Teacher</span>
                </div>
              </div><!-- teacher-item -->
              <div class="teacher-item swiper-slide">
              ...
              <div class="teacher-item swiper-slide">
                ...
                <div class="teacher-content">
                  <h4><a href="{{url('/teacher-details')}}">Gary Harison</a></h4>
                  <span>English Teacher</span>
                </div>
              </div><!-- teacher-item -->
              <div class="teacher-item swiper-slide">
        ...
        <div class="col-lg-4 col-xs-12">
          <div class="features-left">
            <div class="feature-item">
              ...
              <div class="content">
                <h4>Expert Teachers</h4>
                <p>Rapidusly unleash are exceptional partnerships with auhointeropera Efficiently engineer and items.
                </p>
              </div>
            </div><!-- feature item -->
            <div class="feature-item">
        ...
        <div class="col-lg-4 col-xs-12">
          <div class="features-right">
            <div class="feature-item">
              ...
              <div class="content">
                <h4>Expert Teachers</h4>
                <p>Rapidusly unleash are exceptional partnerships with auhointeropera Efficiently engineer items.</p>
              </div>
            </div><!-- feature item -->
            <div class="feature-item">
      ...
      <div class="gallery-two-items">
        <div class="gallery-item">
          <div class="gallery-image">
            <img src="{{asset('images/gallery/gallery_07.jpg')}}" alt="gallery image" class="img-responsive">
        ...
        <div class="gallery-item">
          <div class="gallery-image">
            <img src="{{asset('images/gallery/gallery_08.jpg')}}" alt="gallery image" class="img-responsive">
            <div class="gallery-overlay">
              <div class="bg"></div>
            </div>
            <div class="gallery-content">
        ...
        <div class="gallery-item">
          <div class="gallery-image">
            <img src="{{asset('images/gallery/gallery_09.jpg')}}" alt="gallery image" class="img-responsive">
            <div class="gallery-overlay">
              <div class="bg"></div>
            </div>
            <div class="gallery-content">
        ...
        <div class="gallery-item">
          <div class="gallery-image">
            <img src="{{asset('images/gallery/gallery_10.jpg')}}" alt="gallery image" class="img-responsive">
            <div class="gallery-overlay">
              <div class="bg"></div>
            </div>
            <div class="gallery-content">
          ...
          <div class="swiper-wrapper">
            <div class="testimonial-item swiper-slide">
              <div class="testimonial-details">
                ...
                <img src="{{asset('images/testimonial/testimonial_icon_01.jpg')}}" alt="testimonial icon" class="img-responsive">
              </div>
            ...
            <div class="testimonial-item swiper-slide">
              <div class="testimonial-details">
                <p>Professionally predominate that awesome themes and education timely infrastructures tops
                  ...
                  creative theme longterm high awesome impact</p>
                <h4>Joly Smith <span>ui/ux Designer</span></h4>
                <img src="{{asset('images/testimonial/testimonial_icon_02.jpg')}}" alt="testimonial icon" class="img-responsive">
              </div>
              <div class="testimonial-image">
            ...
            <div class="testimonial-item swiper-slide">
              <div class="testimonial-details">
                <p>Professionally predominate that awesome themes and education timely infrastructures tops
                  ...
                  creative theme longterm high awesome impact</p>
                <h4>Joly Smith <span>ui/ux Designer</span></h4>
                <img src="{{asset('images/testimonial/testimonial_icon_03.jpg')}}" alt="testimonial icon" class="img-responsive">
              </div>
              <div class="testimonial-image">
        ...
        <div class="blog-items">
          <div class="row">
            <div class="col-lg-4 col-sm-6 col-xs-12">
              <div class="blog-item">
                <div class="blog-image">
                  <a href="{{url('/single')}}"><img src="{{asset('images/blog/blog_01.jpg')}}" alt="blog image" class="img-responsive"></a>
                </div>
                <div class="blog-content">
                  <h4><a href="{{url('/single')}}">Actanualze Cententrc Staled</a></h4>
                  <p>Comptely actuaze cent centric coloratons an shang without ainstalled and awesome KidsAcademy PSD
                    Template.</p>
                </div>
                <ul>
            ...
            <div class="col-lg-4 col-sm-6 col-xs-12">
              <div class="blog-item">
                <div class="blog-image">
                  <a href="{{url('/single')}}"><img src="{{asset('images/blog/blog_02.jpg')}}" alt="blog image" class="img-responsive"></a>
                </div>
                <div class="blog-content">
                  <h4><a href="{{url('/single')}}">Actanualze Cententrc Staled</a></h4>
                  <p>Comptely actuaze cent centric coloratons an shang without ainstalled and awesome KidsAcademy PSD
            ...
            <div class="col-lg-4 col-sm-6 col-xs-12">
              <div class="blog-item">
                <div class="blog-image">
                  <a href="{{url('/single')}}"><img src="{{asset('images/blog/blog_03.jpg')}}" alt="blog image" class="img-responsive"></a>
                </div>
                <div class="blog-content">
                  <h4><a href="{{url('/single')}}">Actanualze Cententrc Staled</a></h4>
                  <p>Comptely actuaze cent centric coloratons an shang without ainstalled and awesome KidsAcademy PSD
...
<!-- Mirrored from labartisan.net/demo/kidsacademy/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 21 Feb 2023 12:38:32 GMT -->
</html>
