        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-sm-6 col-xs-12">
                    <div class="class-item">
                        <div class="image">
                            <img src="{{ asset('images/classes/class_02.jpg') }}" alt="class image"
                ...
                <div class="col-lg-4 col-sm-6 col-xs-12">
                    <div class="class-item">
                        <div class="image">
                            <img src="{{ asset('images/classes/class_03.jpg') }}" alt="class image"
                                class="img-responsive">
                        </div>
                        <ul class="schedule">
                            <li>
                ...
                <div class="col-lg-4 col-xs-12">
                    <div class="features-left">
                        <div class="feature-item">
                            ...
                            <div class="content">
                                <h4>Expert Teachers</h4>
                                <p>Rapidusly unleash are exceptional partnerships with auhointeropera Efficiently engineer
                                    and items.
                                </p>
                            </div>
                        </div><!-- feature item -->
