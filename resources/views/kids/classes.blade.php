...
<!-- Mirrored from labartisan.net/demo/kidsacademy/classes.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 21 Feb 2023 12:38:40 GMT -->
<head>
  <meta charset="utf-8">
            ...
            <div class="menu-area">
              ...
              <ul class="menu">
                ...
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    <li class="active"><a href="{{url('/classes')}}">Classes</a></li>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-4 col-sm-6 col-xs-12">
          <div class="class-item">
            <div class="image">
              <img src="{{asset('images/classes/class_04.jpg')}}" alt="class image" class="img-responsive">
            </div>
            <ul class="schedule">
              <li>
                <span>Class Size</span>
        ...
        <div class="col-lg-4 col-sm-6 col-xs-12">
          <div class="class-item">
            <div class="image">
              <img src="{{asset('images/classes/class_05.jpg')}}" alt="class image" class="img-responsive">
            </div>
            <ul class="schedule">
              <li>
                <span>Class Size</span>
        ...
        <div class="col-lg-4 col-sm-6 col-xs-12">
          <div class="class-item">
            <div class="image">
              <img src="{{asset('images/classes/class_06.jpg')}}" alt="class image" class="img-responsive">
            </div>
            <ul class="schedule">
              <li>
                <span>Class Size</span>
        ...
        <div class="col-lg-4 col-sm-6 col-xs-12">
          <div class="class-item">
            <div class="image">
              <img src="{{asset('images/classes/class_07.jpg')}}" alt="class image" class="img-responsive">
            </div>
            <ul class="schedule">
              <li>
                <span>Class Size</span>
        ...
        <div class="col-lg-4 col-sm-6 col-xs-12">
          <div class="class-item">
            <div class="image">
              <img src="{{asset('images/classes/class_08.jpg')}}" alt="class image" class="img-responsive">
            </div>
            <ul class="schedule">
              <li>
                <span>Class Size</span>
        ...
        <div class="col-lg-4 col-sm-6 col-xs-12">
          <div class="class-item">
            <div class="image">
              <img src="{{asset('images/classes/class_09.jpg')}}" alt="class image" class="img-responsive">
            </div>
            <ul class="schedule">
              <li>
                <span>Class Size</span>
...
<!-- Mirrored from labartisan.net/demo/kidsacademy/classes.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 21 Feb 2023 12:38:42 GMT -->
</html>
