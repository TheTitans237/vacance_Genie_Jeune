...
<!-- Mirrored from labartisan.net/demo/kidsacademy/about-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 21 Feb 2023 12:38:38 GMT -->
<head>
  <meta charset="utf-8">
              ...
              <ul class="menu">
                ...
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li class="active"><a href="{{url('/about-2')}}">About Style 02</a></li>
                  </ul>
                </li>
                <!--<li class="dropdown">
            ...
            <div class="swiper-wrapper">
              <div class="teacher-item swiper-slide">
                <div class="teacher-image">
                  <img src="{{asset('images/teachers/teacher_05.jpg')}}" alt="teacher image" class="img-responsive">
                </div>
              ...
              <div class="teacher-item swiper-slide">
                <div class="teacher-image">
                  <img src="{{asset('images/teachers/teacher_06.jpg')}}" alt="teacher image" class="img-responsive">
                </div>
                <div class="teacher-content">
                  <h4><a href="{{url('/teacher-details')}}">Alex bare</a></h4>
                  <span>Art Teacher</span>
                </div>
              </div><!-- teacher-item -->
              <div class="teacher-item swiper-slide">
                <div class="teacher-image">
                  <img src="{{asset('images/teachers/teacher_07.jpg')}}" alt="teacher image" class="img-responsive">
                </div>
                <div class="teacher-content">
                  <h4><a href="{{url('/teacher-details')}}">helas Jhonson</a></h4>
                  <span>English Teacher</span>
                </div>
              </div><!-- teacher-item -->
              <div class="teacher-item swiper-slide">
                <div class="teacher-image">
                  <img src="{{asset('images/teachers/teacher_08.jpg')}}" alt="teacher image" class="img-responsive">
                </div>
                <div class="teacher-content">
                  <h4><a href="{{url('/teacher-details')}}">paul Jhonson</a></h4>
...
<!-- Mirrored from labartisan.net/demo/kidsacademy/about-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 21 Feb 2023 12:38:40 GMT -->
</html>
