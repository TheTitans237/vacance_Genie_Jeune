...
<!-- Mirrored from labartisan.net/demo/kidsacademy/404.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 21 Feb 2023 12:38:49 GMT -->
<head>
  <meta charset="utf-8">
              ...
              <ul class="menu">
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li><a href="{{url('/boxed-layout')}}">Boxed Layout</a></li>
                ...
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li class="active"><a href="{{url('/404')}}">404 Error</a></li>
                  </ul>
                </li>
                <li class="dropdown">
                  <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
