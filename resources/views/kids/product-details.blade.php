...
<!-- Mirrored from labartisan.net/demo/kidsacademy/product-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 21 Feb 2023 12:38:58 GMT -->
<head>
  <meta charset="utf-8">
              ...
              <ul class="menu">
                ...
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li class="active"><a href="{{url('/product-details')}}">Product Details</a></li>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="product-slider">
                  ...
                  <div id="slider" class="flexslider">
                    <ul class="slides">
                      <li><img src="{{asset('images/product/slider_bg_01.jpg')}}" alt="porduct image" class="img-responsive" /></li>
                      <li><img src="{{asset('images/product/slider_bg_02.jpg')}}" alt="porduct image" class="img-responsive" /></li>
                      <li><img src="{{asset('images/product/slider_bg_03.jpg')}}" alt="porduct image" class="img-responsive" /></li>
                      <li><img src="{{asset('images/product/slider_bg_04.jpg')}}" alt="porduct image" class="img-responsive" /></li>
                      <li><img src="{{asset('images/product/slider_bg_05.jpg')}}" alt="porduct image" class="img-responsive" /></li>
                      <li><img src="{{asset('images/product/slider_bg_06.jpg')}}" alt="porduct image" class="img-responsive" /></li>
                    </ul>
                  </div>
                  <div id="carousel" class="flexslider">
                    <ul class="slides">
                      <li><img src="{{asset('images/product/slider_sm_01.jpg')}}" alt="porduct image" class="img-responsive" />
                        <span></span>
                      </li>
                      <li><img src="{{asset('images/product/slider_sm_02.jpg')}}" alt="porduct image" class="img-responsive" />
                        <span></span>
                      </li>
                      <li><img src="{{asset('images/product/slider_sm_03.jpg')}}" alt="porduct image" class="img-responsive" />
                        <span></span>
                      </li>
                      <li><img src="{{asset('images/product/slider_sm_04.jpg')}}" alt="porduct image" class="img-responsive" />
                        <span></span>
                      </li>
                      <li><img src="{{asset('images/product/slider_sm_05.jpg')}}" alt="porduct image" class="img-responsive" />
                        <span></span>
                      </li>
                      <li><img src="{{asset('images/product/slider_sm_06.jpg')}}" alt="porduct image" class="img-responsive" />
                        <span></span>
                      </li>
                    </ul>
                  </div>
              ...
              <div class="col-md-6">
                <div class="details">
                  ...
                  <span>$250.00</span>
                  <p>Intactvely engineers prospectives competencies rather and resource sucking process imrovement
                    ompetently envisioneer real awesome theme a and internalsources through aweosme product event
                    t-shart.</p>

                  <select>
                    <option>Select Size</option>
                    <option>Small</option>
                    <option>Midiam</option>
                    <option>Large</option>
                  </select>
                  <select>
          ...
          <div class="pro-description">
            <ul class="nav nav-tabs" role="tablist">
              <li role="presentation" class="active"><a href="#sescription" aria-controls="sescription" role="tab"
                  data-bs-toggle="tab" data-bs-target="#sescription">Description</a></li>
            ...
            <div class="tab-content">
              <div role="tabpanel" class="tab-pane active" id="sescription">
                <p>Donec vitae enim quis felis commodo vehicula non et orci. Cras quis eros mauris. Donec and
                  sollicitudin bibende purus. Duis elementum mollis lorem non pretium. Aliquam vel turpis feugiat ante
                  aliquam and the congue. Etiam tempus urna sit amet neque faucibus commodo. Nullam sagittis felis
                  triique, tpor erat sit amet, vulputate mauris. Ut lacinia, dolor at commodo and fringilla, nibh enim
                  vehicula odio, in faucibus urna est sed liula. Integer molest aliquet arcu, vitae is lobortis enim
                  finibus.</p>
                <p>Donec vitae enim quis felis commodo vehicula non et orci. Cras quis eros mauris. Donec and
                  sollicitudin bibende purus. Duis elementum mollis lorem non pretium. Aliquam vel turpis feugiat ante
                  aliquam and the congue. Etiam tempus urna sit amet neque faucibus commodo. Nullam sagittis felis
              ...
              <div role="tabpanel" class="tab-pane" id="reviews">
                <div class="pro-reviews">
                  ...
                  <div class="review-item">
                    <div class="image">
                      <img src="{{asset('images/product/review_01.jpg')}}" alt="client image" class="img-responsive">
                    </div>
                    <div class="content">
                      <div class="title">
                        <h5>Robot Smith</h5>
                      ...
                      <p>Objectively enable scalable leadership without and media leadership theme awesome theme without
                        flexible solutions awesome theme are interactive architectures.</p>
                    </div>
                  </div><!-- review item -->
                  <div class="review-item">
                    <div class="image">
                      <img src="{{asset('images/product/review_02.jpg')}}" alt="client image" class="img-responsive">
                    </div>
                    <div class="content">
                      <div class="title">
                        <h5>Janaton Doe</h5>
                  ...
                  <div class="review-item">
                    <div class="image">
                      <img src="{{asset('images/product/review_03.jpg')}}" alt="client image" class="img-responsive">
                    </div>
                    <div class="content">
                      <div class="title">
                        <h5>Robot Jhonson</h5>
                  ...
                  <div class="review-item">
                    <div class="image">
                      <img src="{{asset('images/product/review_04.jpg')}}" alt="client image" class="img-responsive">
                    </div>
                    <div class="content">
                      <div class="title">
                        <h5>Janaton Smith</h5>
...
<!-- Mirrored from labartisan.net/demo/kidsacademy/product-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 21 Feb 2023 12:39:03 GMT -->
</html>
