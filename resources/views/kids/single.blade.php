...
<!-- Mirrored from labartisan.net/demo/kidsacademy/single.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 21 Feb 2023 12:38:50 GMT -->
<head>
  <meta charset="utf-8">
            ...
            <div class="post-comments">
              ...
              <ul>
                <li>
                  <div class="the-comment">
                    <div class="comment-image">
                      <img src="{{asset('images/blog/user_01.jpg')}}" alt="user image" class="img-responsive">
                    </div>
                  ...
                  <ul>
                    <li>
                      <div class="the-comment">
                        <div class="comment-image">
                          <img src="{{asset('images/blog/user_02.jpg')}}" alt="user image" class="img-responsive">
                        </div>
                        <div class="comment-content">
                          <h4>Janaton Smith</h4>
                          <span class="day"> 02 days ago at 10:30pm </span>
                ...
                <li>
                  <div class="the-comment">
                    <div class="comment-image">
                      <img src="{{asset('images/blog/user_03.jpg')}}" alt="user image" class="img-responsive">
                    </div>
                    <div class="comment-content">
                      <h4>Jhonson Smith</h4>
                      <span class="day"> 02 days ago at 10:30pm </span>
...
<!-- Mirrored from labartisan.net/demo/kidsacademy/single.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 21 Feb 2023 12:38:51 GMT -->
</html>
